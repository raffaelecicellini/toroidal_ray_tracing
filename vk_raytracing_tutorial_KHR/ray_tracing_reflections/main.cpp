...
int main(int argc, char** argv)
{
  ...
  helloVk.loadModel(nvh::findFile("media/scenes/cube_multi.obj", defaultSearchPaths, true), 
                    nvmath::translation_mat4(nvmath::vec3f(0, 0, 0)));
  ...
  // Fourth scene - nigerian struct
  /* helloVk.loadModel(nvh::findFile("media/scenes/H01.obj", defaultSearchPaths, true),
                    nvmath::translation_mat4(nvmath::vec3f(0, 0, 0)) * nvmath::scale_mat4(nvmath::vec3f(0.08f, 0.08f, 0.08f)));
  helloVk.loadModel(nvh::findFile("media/scenes/plane.obj", defaultSearchPaths, true),
                    nvmath::translation_mat4(nvmath::vec3f(0, 0, 0)) * nvmath::scale_mat4(nvmath::vec3f(10.f, 10.f, 10.f)));*/
  ...
  nvmath::vec4f clearColor   = nvmath::vec4f(1.0, 1.0, 1.0, 1.00f);
