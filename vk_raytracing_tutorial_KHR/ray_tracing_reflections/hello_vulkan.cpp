...
void HelloVulkan::createTopLevelAS()
{
  ...
  m_rtBuilder.buildTlas(m_tlas, VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_BIT_KHR
                                    | VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_UPDATE_BIT_KHR);  // helper function to create the TLAS given all the instances, we are deciding to build it favoring fast trace wrt AS size
}
...
void HelloVulkan::writeColorImage(const char* dir)
{
  ...
  std::string filename;
  // filename = "data/simple0gTruth.txt";
  // filename = "data/simple1gTruth.txt";
  // filename = "data/simple2gTruth.txt";
  // filename = "data/city0gTruth.txt";
  // filename = "data/city1gTruth.txt";
  // filename = "data/city2gTruth.txt";
  // filename = "data/house0gTruth.txt";
  // filename = "data/house1gTruth.txt";
  filename = "data/house2gTruth.txt";
